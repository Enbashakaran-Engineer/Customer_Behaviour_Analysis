...
-- 4) Compare the average Purcghase amount btn Standard and Express Shipping.
select shipping_type, ROUND(AVG(purchase_amount),2) from customer
where shipping_type in ('Standard','Express')
group by shipping_type

-- 5) Do Subscribed customers spend more? Compare average spend and total revenue btn subscribers and non-subscribers
